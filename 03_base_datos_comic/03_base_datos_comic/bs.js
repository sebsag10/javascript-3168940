...
capitulos: [
  {
    ...
    descripcion: "Elkin descubre su voz interior en medio del caos universitario. Entre dudas, sueños y rebeldía, nace la chispa de lo que se convertirá en una revolución musical.",
    subtexto: "Los inicios universitarios de Elkin y el nacimiento de su pasión musical."
  },
  {
    id: 2,
    nombre: "La batalla",
    portada: "./IMGS/caps/cap_2.png",
    descripcion: "La banda enfrenta la represión del sistema. Entre protestas, discursos y guitarras encendidas, Elkin debe decidir entre la fama o la verdad.",
    subtexto: "Protestas, represión y la encrucijada entre fama y principios."
  },
  {
    id: 3,
    nombre: "El legado",
    portada: "./IMGS/caps/cap_3.png",
    descripcion: "Elkin deja su mensaje para una nueva generación: el arte como resistencia y la voz como símbolo eterno. El espíritu de Arkana se convierte en inmortal.",
    subtexto: "El mensaje eterno de Elkin: arte como resistencia para el futuro."
  }
]
};
